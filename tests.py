...
class TestStrategoMethods(unittest.TestCase):
    """
    Tests depend on test_board.txt file, that contain such board:
    ...
    def test_loading_from_file(self):
        ...
        self.assertTrue(board.data[0][1] == 1)
    ...
    def test_available_positions(self):
        """
        Make sure that available positions are being properly delivered
        :return:
        """
        board = Board.load_from_file("test_board.txt")
